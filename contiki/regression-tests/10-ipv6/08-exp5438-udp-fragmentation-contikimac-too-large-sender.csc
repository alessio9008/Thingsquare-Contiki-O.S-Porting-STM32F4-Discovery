...
<simconf>
  ...
  <simulation>
    ...
    <motetype>
      ...
      <source EXPORT="discard">[CONTIKI_DIR]/regression-tests/10-ipv6/code/sender/udp-sender.c</source>
...
make udp-sender.exp5438 DEFINES=NETSTACK_CONF_RDC=contikimac_driver,SIZE=500,BUFSIZE=200 TARGET=exp5438</commands>
      <firmware EXPORT="copy">[CONTIKI_DIR]/regression-tests/10-ipv6/code/sender/udp-sender.exp5438</firmware>
