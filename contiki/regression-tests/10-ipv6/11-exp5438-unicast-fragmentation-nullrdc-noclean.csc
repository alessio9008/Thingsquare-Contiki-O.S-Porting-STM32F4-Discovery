...
<simconf>
  ...
  <simulation>
    ...
    <motetype>
      ...
      <source EXPORT="discard">[CONTIKI_DIR]/regression-tests/10-ipv6/code/sender/unicast-sender.c</source>
...
make unicast-sender.exp5438 DEFINES=NETSTACK_CONF_RDC=nullrdc_driver,SIZE=400,BUFSIZE=500 TARGET=exp5438</commands>
      <firmware EXPORT="copy">[CONTIKI_DIR]/regression-tests/10-ipv6/code/sender/unicast-sender.exp5438</firmware>
    ...
    <motetype>
      ...
      <source EXPORT="discard">[CONTIKI_DIR]/regression-tests/10-ipv6/code/receiver/udp-receiver.c</source>
      <commands EXPORT="discard">
make udp-receiver.exp5438 DEFINES=NETSTACK_CONF_RDC=nullrdc_driver,SIZE=400,BUFSIZE=500 TARGET=exp5438</commands>
      <firmware EXPORT="copy">[CONTIKI_DIR]/regression-tests/10-ipv6/code/receiver/udp-receiver.exp5438</firmware>
      <moteinterface>se.sics.cooja.interfaces.Position</moteinterface>
      <moteinterface>se.sics.cooja.interfaces.RimeAddress</moteinterface>
      <moteinterface>se.sics.cooja.interfaces.IPAddress</moteinterface>
      <moteinterface>se.sics.cooja.interfaces.Mote2MoteRelations</moteinterface>
