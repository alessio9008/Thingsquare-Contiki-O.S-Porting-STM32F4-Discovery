...
#define SPIRIT_SPI_PERIPH_RCC                 RCC_APB1Periph_SPI3

/* Defines for MOSI pin*/
#define SPIRIT_SPI_PERIPH_MOSI_PORT           GPIOC
#define SPIRIT_SPI_PERIPH_MOSI_PIN            GPIO_Pin_12
#define SPIRIT_SPI_PERIPH_MOSI_AF             GPIO_AF_SPI3
#define SPIRIT_SPI_PERIPH_MOSI_RCC            RCC_AHB1Periph_GPIOC
#define SPIRIT_SPI_PERIPH_MOSI_RCC_SOURCE     GPIO_PinSource12

/* Defines for MISO pin */
#define SPIRIT_SPI_PERIPH_MISO_PORT           GPIOC
#define SPIRIT_SPI_PERIPH_MISO_PIN            GPIO_Pin_11
#define SPIRIT_SPI_PERIPH_MISO_AF             GPIO_AF_SPI3
#define SPIRIT_SPI_PERIPH_MISO_RCC            RCC_AHB1Periph_GPIOC
#define SPIRIT_SPI_PERIPH_MISO_RCC_SOURCE     GPIO_PinSource11

/* Defines for SCLK pin */
#define SPIRIT_SPI_PERIPH_SCLK_PORT           GPIOC
#define SPIRIT_SPI_PERIPH_SCLK_PIN            GPIO_Pin_10
#define SPIRIT_SPI_PERIPH_SCLK_AF             GPIO_AF_SPI3
#define SPIRIT_SPI_PERIPH_SCLK_RCC            RCC_AHB1Periph_GPIOC
#define SPIRIT_SPI_PERIPH_SCLK_RCC_SOURCE     GPIO_PinSource10

/* Defines for chip select pin */
#define SPIRIT_SPI_PERIPH_CS_PORT             GPIOA
#define SPIRIT_SPI_PERIPH_CS_PIN              GPIO_Pin_4
#define SPIRIT_SPI_PERIPH_CS_RCC              RCC_AHB1Periph_GPIOA
#define SPIRIT_SPI_PERIPH_CS_RCC_SOURCE       GPIO_PinSource4
