...
uint16_t SdkEvalPmGetV(SdkEvalAdcChannel xAdcCh)
{
  ...
  ADC_RegularChannelConfig(ADC1, xAdcCh, 1, ADC_SampleTime_56Cycles);
  ...
  /* STM32L1: Waits until the ADC1 is ready (non disponibile in F4)*/
...
void SdkEvalPmRfSwitchInit(void)
{
  ...
  RCC_AHB1PeriphClockCmd(RF_SWITCH_RCC, ENABLE);
