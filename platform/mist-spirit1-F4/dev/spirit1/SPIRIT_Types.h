...
/**
 * @brief The GET_STATUS() macro returns the Spirit Status through the global variable g_xStatus.
 */
#define GET_STATUS()     g_xStatus
...
/**
 * @brief  Returns the MC State of SPIRIT as defined in @ref SpiritState, having as
 *         input the SPIRIT status as defined in @ref SpiritStatus.
 */
#define GET_MC_STATE(STATUS)      ((SpiritState)(STATUS.MC_STATE))
