...
typedef struct
{
  ...
  SpiritFunctionalState     xCsmaSeedReloadMode;          /*!< Specifies if the CSMA seed reload mode has to be on or off. Not used in persistent mode.
                                                               This parameter can be S_ENABLE or S_DISABLE */
...
SpiritFunctionalState SpiritGetCsma(void);
